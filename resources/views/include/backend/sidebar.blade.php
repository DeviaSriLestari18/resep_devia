<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div style="width: 700px;"
        ...
        <a class="sidebar-brand brand-logo" href="{{ route('home') }}"><img src="{{ asset('assets/images/mknn.png') }}"
                alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="{{ route('home') }}"><img
                src="{{ asset('assets/images/mknn.jpg') }}" alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('bahan.index') }}">Bahan</a></li>
